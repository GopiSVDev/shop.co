...
const TestimonialCard = ({
  ...
  return (
    <div className="px-[clamp(1.5rem,1.3571428571428572rem+0.7142857142857143vw,2rem)] py-[clamp(1.5rem,1.4285714285714286rem+0.35714285714285715vw,1.75rem)] border border-[hsla(0,0%,0%,0.1)] rounded-[20px] font-satoshi flex flex-col gap-2 max-w-[400px]">
